...
public class Login extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        fpassw=(TextView) findViewById(R.id.forgotpassw);
        ...
        registrar.setOnClickListener(new View.OnClickListener(){
        	...
        	public void onClick(View view){
        		...
        		String url = "http://"+setting.IP_Server+"/droidlogin/adduser.html";
        ...
        fpassw.setOnClickListener(new View.OnClickListener(){
        	...
        	public void onClick(View view){
        	    ...
        	    Toast toast1 = Toast.makeText(getApplicationContext(),"Pos nimodo... es una alpha todavia :v", Toast.LENGTH_LONG);
         	    toast1.show(); 
        								}        	
        														});
    ...
    public boolean loginstatus(String username ,String password ) {
    	...
    	ArrayList<NameValuePair> postparameters2send= new ArrayList<NameValuePair>();
		   ...
		   //realizamos una peticion y como respuesta obtenes un array JSON
      		JSONArray jdata=post.getserverdata(postparameters2send, setting.URL_connect+"/acces.php");
    ...
    class asynclogin extends AsyncTask< String, String, String > {
        ...
        protected void onPostExecute(String result) {
           ...
           if (result.equals("ok")){
				...
				Intent i=new Intent(Login.this, Mesh.class);
