...
public class Mesh2  extends Activity
{
	String user;
	int index[];
    Httppostaux post;
	...
	private void loadList(){
		...
		String[] values = consultarPropios(user);
		...
		public void onItemClick(AdapterView<?> parent, final View view,
            	...
            	if(position<index.length){
            		Intent i=new Intent(Mesh2.this, Message.class);
    ...
    public String[] consultarPropios(String user){/**/
		int ThreadID;
		String desc;
		int userID;
    	...
    	usuario.add(new BasicNameValuePair("user",String.valueOf(userID)));
  		...
  		JSONArray jdata=post.getserverdata(usuario, setting.URL_connect+"/getmine.php");
